...
class anothercart extends StatefulWidget {
  @override
  _anothercartState createState() => _anothercartState();
}

class _anothercartState extends State<anothercart> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          GestureDetector(
            onTap: () {
              router.go('/navscreen/category/description/gotocart/chechkout');
