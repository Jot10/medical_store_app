...
class slivercart extends StatefulWidget {
  const slivercart({super.key});

  @override
  State<slivercart> createState() => _slivercartState();
}

class _slivercartState extends State<slivercart> {
      ...
      body:CustomScrollView(
        slivers: [
                              ...
                              children: [
                                ...
                                Stack(
                                  children: [
                                    ...
                                    Positioned(
                                      top: 16,left: 20,
                                      child: Container(width: 50,height: 34,color: greycont,)),
                                      Positioned(
                                        top: 9,left: 0,
                                        child: IconButton(
                                      icon:
         ...
         SliverList(delegate: SliverChildListDelegate([
          ...
          GestureDetector(
            onTap: () {
              var param2='Rs:${getTotalPrice().toStringAsFixed(2)}';
              context.goNamed('price',pathParameters: {'price':param2});

              //router.go('/navscreen/cartcheckout');
